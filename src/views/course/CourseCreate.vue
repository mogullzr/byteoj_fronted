              ...
              <el-table-column label="操作" width="200" align="center">
                <template #default="{ $index }">
                  <el-button 
                    ...
                    :disabled="$index === 0"
                    class="bg-blue-600 hover:bg-blue-700 shadow-md mr-1">
                    ↑
                  </el-button>
                  <el-button 
                    type="primary" 
                    ...
                    :disabled="$index === form.courseProblemsList.length - 1"
                    class="bg-blue-600 hover:bg-blue-700 shadow-md mr-1">
                    ↓
                  </el-button>
              ...
              <el-table-column label="操作" width="200" align="center">
                <template #default="{ $index }">
                  ...
                  <el-button 
                    ...
                    :disabled="$index === selectedChapter.courseProblemList.length - 1"
                    class="bg-blue-600 hover:bg-blue-700 shadow-md mr-1">
                    ↓
                  </el-button>
              ...
              <el-table-column label="操作" width="200" align="center">
                <template #default="{ $index }">
                  ...
                  <el-button 
                    ...
                    :disabled="$index === selectedCategory.courseProblemList.length - 1"
                    class="bg-blue-600 hover:bg-blue-700 shadow-md mr-1">
                    ↓
                  </el-button>
...
const moveChapterUp = (index) => {
  if (index > 0) {
    const temp = form.courseProblemsList[index]
    form.courseProblemsList[index] = form.courseProblemsList[index - 1]
    form.courseProblemsList[index - 1] = temp
    
    // 更新选中状态
    if (selectedChapterIndex.value === index) {
      selectedChapterIndex.value = index - 1
    } else if (selectedChapterIndex.value === index - 1) {
      selectedChapterIndex.value = index
    }
    console.log('Moved chapter up from index:', index, 'to:', index - 1)
  }
}

const moveChapterDown = (index) => {
  if (index < form.courseProblemsList.length - 1) {
    const temp = form.courseProblemsList[index]
    form.courseProblemsList[index] = form.courseProblemsList[index + 1]
    form.courseProblemsList[index + 1] = temp
    ...
    console.log('Moved chapter down from index:', index, 'to:', index + 1)
  }
}

// 类别移动功能
const moveCategoryUp = (index) => {
  if (selectedChapterIndex.value !== -1 && index > 0) {
    const categories = form.courseProblemsList[selectedChapterIndex.value].courseProblemList
    ...
    } else if (selectedCategoryIndex.value === index - 1) {
      selectedCategoryIndex.value = index
    }
    console.log('Moved category up from index:', index, 'to:', index - 1)
  }
}
...
const moveCategoryDown = (index) => {
  if (selectedChapterIndex.value !== -1) {
    ...
    if (index < categories.length - 1) {
      ...
      console.log('Moved category down from index:', index, 'to:', index + 1)
    }
  }
}
...
const moveProblemUp = (index) => {
  if (selectedChapterIndex.value !== -1 && selectedCategoryIndex.value !== -1 && index > 0) {
    const problems = form.courseProblemsList[selectedChapterIndex.value]
      .courseProblemList[selectedCategoryIndex.value].courseProblemList
    const temp = problems[index]
    problems[index] = problems[index - 1]
    problems[index - 1] = temp
    console.log('Moved problem up from index:', index, 'to:', index - 1)
  }
}

const moveProblemDown = (index) => {
  if (selectedChapterIndex.value !== -1 && selectedCategoryIndex.value !== -1) {
    const problems = form.courseProblemsList[selectedChapterIndex.value]
      .courseProblemList[selectedCategoryIndex.value].courseProblemList
    if (index < problems.length - 1) {
      ...
      problems[index] = problems[index + 1]
      problems[index + 1] = temp
      console.log('Moved problem down from index:', index, 'to:', index + 1)
    }
  }
}
