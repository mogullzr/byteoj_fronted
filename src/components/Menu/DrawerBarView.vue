  ...
  >
    <el-sub-menu index="1">
      ...
      <el-menu-item-group
        ...
        @click="RouterToAdminList"
      >
        <template #title><span>管理员</span></template>
        <el-menu-item index="1-1-1">管理员管理</el-menu-item>
      </el-menu-item-group>
      <el-menu-item-group>
    ...
    <el-sub-menu index="3">
      ...
      <el-menu-item-group>
        <template #title><span>算法比赛</span></template>
        <el-menu-item index="3-1-1">算法比赛创建</el-menu-item>
        <el-menu-item index="3-1-2">算法比赛管理</el-menu-item>
      </el-menu-item-group>
      <el-menu-item-group>
        <template #title><span>数学408试题比赛</span></template>
        <el-menu-item index="3-2-1">数学408比赛创建</el-menu-item>
        <el-menu-item index="3-2-2">数学408比赛管理</el-menu-item>
      </el-menu-item-group>
    </el-sub-menu>
    <el-sub-menu index="4">
      <template #title>
    ...
    <el-sub-menu index="5">
      ...
      <el-menu-item-group>
        ...
        <el-menu-item index="5-1-1" @click="RouterToCourseControl"
          >课程信息管理</el-menu-item
        >
      </el-menu-item-group>
    </el-sub-menu>
