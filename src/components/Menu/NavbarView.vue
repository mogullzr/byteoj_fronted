        ...
        <ul class="menu menu-horizontal">
          ...
          <li class="dropdown" :class="{ 'dropdown-open': isMoreMenuOpen }">
            ...
            <ul v-show="isMoreMenuOpen" tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-50" @click.stop>
              ...
              <li>
                <a @click.prevent="handleNavigation('/update')" href="/studyPath">网站更新日志</a>
              </li>
              <li>
          ...
          <ul tabindex="0" class="shadow menu dropdown-content bg-base-100 rounded-box w-40 mt-3 z-50" >
            ...
            <li v-if="useStore.loginUser.role && useStore.loginUser.role !== ACCESS_ENUM.NOT_LOGIN">
              <router-link to="/user/blog">
                <svg t="1768290857609" class="ml-4 icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1677" width="24" height="24"><path d="M999.424 69.391059a1070.381176 1070.381176 0 0 0-179.561412-14.697412c-126.795294 0-230.580706 22.046118-308.705882 65.536C419.719529 74.149647 314.548706 50.838588 198.174118 50.838588c-101.255529 0-172.634353 18.191059-175.585883 18.974118L0 75.715765l0.060235 837.632 37.586824-9.697883c0.662588-0.120471 67.463529-17.046588 160.527059-17.046588 87.160471 0 166.912 14.456471 238.531764 42.345412v49.874823h150.588236v-51.561411c77.161412-29.394824 165.466353-36.803765 232.508235-36.803765 94.087529 0 167.815529 13.552941 168.538353 13.673412l35.659294 6.625882V74.029176l-24.576-4.638117zM60.235294 837.692235V123.422118a769.204706 769.204706 0 0 1 137.938824-12.348236c106.074353 0 201.125647 21.684706 283.708235 62.885647v709.330824c-84.510118-37.165176-179.320471-56.922353-283.708235-56.922353-58.368 0-106.797176 6.083765-137.938824 11.324235z m903.529412 1.867294a1135.073882 1135.073882 0 0 0-143.962353-9.276235c-111.314824 0-203.655529 17.950118-277.684706 51.501177V172.634353c85.654588-46.983529 197.029647-57.705412 277.684706-57.705412 61.620706 0 114.567529 5.842824 143.962353 9.878588v714.752z" p-id="1678"></path></svg>
                个人博客
              </router-link>
            </li>
            <li v-if="useStore.loginUser.role && useStore.loginUser.role !== ACCESS_ENUM.NOT_LOGIN">
