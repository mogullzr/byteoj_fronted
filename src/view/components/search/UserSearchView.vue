...
<template>
  ...
  <div v-for="data in dataList" class="post-item">
    ...
    <div class="flex mt-4">
      ...
      <div class="flex-1">
        <div class="font-bold" v-html="highlightKeyword(data.username, <string>route.query.keyword ?? '')"></div>
    ...
    <div class="hover-button">
      <button @click="router.push('/user/space/' + data.uuid)" class="select-button font-bold">点击进入用户中心</button>
    </div>
  </div>
</template>
