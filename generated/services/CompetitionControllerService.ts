...
export class CompetitionControllerService {
    ...
    /**
     * competitionProblemsAdminGet
     * @param competitionId competition_id
     * @returns BaseResponse_List_CompetitionProblemsVo_ OK
     * @throws ApiError
     */
    public static competitionProblemsAdminGetUsingGet(
        competitionId?: number,
    ): CancelablePromise<BaseResponse_List_CompetitionProblemsVo_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/competition/admin/problems/get',
            query: {
                'competition_id': competitionId,
            },
            errors: {
