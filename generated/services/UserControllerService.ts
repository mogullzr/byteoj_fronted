...
export class UserControllerService {
     ...
     * @throws ApiError
     */
    public static bossAdminGetAdminListUsingPost(): CancelablePromise<BaseResponse_List_User_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static adminGetUserPagesUsingPost(): CancelablePromise<BaseResponse_long_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
